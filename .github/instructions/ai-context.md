# AI Context & Instructions for ha-ctgpdx

## 🧬 Project DNA
**Repository:** `ha-ctgpdx`
**Type:** Home Assistant Custom Integration
**Domain:** `ctgpdx`
**Description:** The `ctgpdx` sensor provides the latest CTGP Deluxe version available, allowing you to get notified when updates are released.
...
### 🚀 Google Antigravity
- **Codebase Navigation:** Begin by analyzing `custom_components/ctgpdx/`. Search for established patterns in `api.py` or `coordinator.py` before modifying entities.
